...
class Asset
{
    ...
    {
        // add enqueue hook
        Hook::add('wp_enqueue_scripts', [$this, 'enqueue'], 'action', 1);
    }
     ...
     * @return bool
     */
    public function addScript($handle, $src = null, $deps = [], $ver = false, $inFooter = false)
    {
        $args = func_get_args();
        array_shift($args);
     ...
     * @return bool
     */
    public function addStyle($handle, $src = null, $deps = [], $ver = false, $media = false)
    {
        $args = func_get_args();
        array_shift($args);
     ...
     * @return bool
     */
    public function add($handle, $type, $args = [])
    {
